...
class TestFetchVersionInfoLegacy:
    ...
    def test_fetch_version_info_legacy_success(
        self, manifest_generator, version_detector, sample_config
    ):
    ...
    def test_fetch_version_info_legacy_version_not_found(
        self, manifest_generator, version_detector, sample_config
    ):
    ...
    def test_fetch_version_info_legacy_network_error(
        self, manifest_generator, version_detector, sample_config
    ):
...
class TestGenerateManifest:
    ...
    def test_generate_manifest_basic(
        self, manifest_generator, version_detector, sample_config, temp_bucket_dir
    ):
    ...
    def test_generate_manifest_with_bin_name(
        self, manifest_generator, version_detector, sample_config, temp_bucket_dir
    ):
    ...
    def test_generate_manifest_with_shortcuts(
        self, manifest_generator, version_detector, sample_config, temp_bucket_dir
    ):
    ...
    def test_generate_manifest_with_extract_dir(
        self, manifest_generator, version_detector, temp_bucket_dir
    ):
    ...
    def test_generate_manifest_with_post_install(
        self, manifest_generator, version_detector, temp_bucket_dir
    ):
