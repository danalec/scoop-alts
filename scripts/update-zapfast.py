...
HOMEPAGE_URL = "https://github.com/crmne/zapfast/releases"
DOWNLOAD_URL_TEMPLATE = "https://github.com/crmne/zapfast/releases/download/v$version/zapfast-v$version-x86_64-pc-windows-msvc.zip"
...
def update_manifest(force: bool = False) -> bool:
    ...
    config = SoftwareVersionConfig(
        ...
        description="Fast, native WhatsApp client in Rust and egui",
        license="MIT",
