...
class LazyeatUpdater:
    """Handles Lazyeat updates"""
        ...
        try:
            ...
            for pattern in version_patterns:
                ...
                if matches:
                    ...
                    print(f"✅ Found Lazyeat version: {latest_version}")
    ...
    def commit_and_push(self, version: str) -> bool:
        ...
        try:
            ...
            commit_message = f"Update lazyeat to version {version}"
    ...
    def run_update(self) -> bool:
        """Main update process"""
        print(f"🚀 Starting Lazyeat update check...")
        ...
        try:
            ...
            if self.update_manifest(latest_version, download_url, file_hash):
                print(f"✅ Successfully updated Lazyeat to version {latest_version}")
...
def main():
    """Main function"""
    updater = LazyeatUpdater()
    success = updater.run_update()
    
    if success:
        print(f"✨ Lazyeat update check completed")
    else:
        print(f"💥 Lazyeat update check failed")
        exit(1)
