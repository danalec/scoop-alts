...
class EsptoolUpdater:
    """Handles Esptool updates"""
        ...
        try:
            ...
            for pattern in version_patterns:
                ...
                if matches:
                    ...
                    print(f"✅ Found Esptool version: {latest_version}")
    ...
    def commit_and_push(self, version: str) -> bool:
        ...
        try:
            ...
            commit_message = f"Update esptool to version {version}"
    ...
    def run_update(self) -> bool:
        """Main update process"""
        print(f"🚀 Starting Esptool update check...")
        ...
        try:
            ...
            if self.update_manifest(latest_version, download_url, file_hash):
                print(f"✅ Successfully updated Esptool to version {latest_version}")
...
def main():
    """Main function"""
    updater = EsptoolUpdater()
    success = updater.run_update()
    
    if success:
        print(f"✨ Esptool update check completed")
    else:
        print(f"💥 Esptool update check failed")
        exit(1)
