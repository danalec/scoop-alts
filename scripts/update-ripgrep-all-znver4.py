#!/usr/bin/env python3
"""
Ripgrep All (Zen 4+ tuned) Update Script
...
# Configuration
SOFTWARE_NAME = "ripgrep-all-znver4"
HOMEPAGE_URL = "https://github.com/danalec/ripgrep-all/releases"
DOWNLOAD_URL_TEMPLATE = "https://github.com/danalec/ripgrep-all/releases/download/v$version/ripgrep_all-v$version-x86_64-pc-windows-msvc-znver4.zip"
...
def update_manifest(force: bool = False) -> bool:
    ...
    config = SoftwareVersionConfig(
        ...
        description="Ripgrep-All - search in PDFs, e-books, Office docs (incl. legacy .doc and .rtf), archives, and media via ripgrep (danalec community build, Zen 4+ tuned)",
